...
<link rel="stylesheet" type="text/css" 
		href="${rootPath}/resources/css/main2.css?ver=20190719-01">
<link rel="stylesheet" type="text/css" 
		href="${rootPath}/resources/css/list.css?ver=20190719-01">
<link rel="stylesheet" type="text/css" 
		href="${rootPath}/resources/css/input.css?ver=20190719-01">
